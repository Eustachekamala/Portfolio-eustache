...
const services = [
  ...
  },
  {
    ...
    href: "/work?category=DevOps",
  },
];

const Services = () => {
  return (
    <section className="min-h-[80vh] flex justify-center py-12 xl:py-0  md:mt-0 lg:mt-6">
        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Title */}
              <h2 className="text-[42px] font-bold leading-none text-white group-hover:text-accent-500 transition-all duration-500">
                {service.title}
              </h2>
